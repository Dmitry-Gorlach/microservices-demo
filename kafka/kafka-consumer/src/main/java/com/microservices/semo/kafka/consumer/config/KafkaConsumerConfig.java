package com.microservices.semo.kafka.consumer.config;
...
public class KafkaConsumerConfig<K extends Serializable, V extends SpecificRecordBase> {
    ...
    public Map<String, Object> consumerConfig() {
        ...
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, kafkaConsumerConfigData.getSpecificAvroReaderKey());
    ...
    public ConsumerFactory<K, V> consumerFactory() {
        return new DefaultKafkaConsumerFactory<K,V>(consumerConfig());
    }
